 ...
 */
public class EnumClassInfoWrapper<E extends Enum<E>> {

    private final Class<E> enumClass;
    private final String[] names;
    private final HashMap<String, E> parseMap = new HashMap<>();

    public EnumClassInfoWrapper(@NotNull Class<E> c, E[] constants, @Nullable String prefix, @Nullable String suffix) {
        assert c.isEnum();
        this.enumClass = c;
    ...
    public EnumClassInfoWrapper(@NotNull Class<E> c, @Nullable String prefix, @Nullable String suffix) {
        this(c, c.getEnumConstants(), prefix, suffix);
    }

    public EnumClassInfoWrapper(@NotNull Class<E> c) {
        this(c, null, null);
    }
    ...
    static class EnumParser<T extends Enum<T>> extends Parser<T> {
        ...
        private final EnumClassInfoWrapper<T> enumWrapper;

        public EnumParser(EnumClassInfoWrapper<T> enumWrapper) {

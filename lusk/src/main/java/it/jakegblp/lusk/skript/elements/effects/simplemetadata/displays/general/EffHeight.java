...
public class EffHeight extends Effect {
    ...
    protected void execute(Event event) {
        AddonUtils.sendEasyMetadata(playerExpression.getArray(event), EntityMetadata.of(Map.of(MetadataKeys.DisplayKeys.DISPLAY_HEIGHT, numberExpression.getSingle(event).floatValue())), entityOrId.getArray(event));
    }

package it.jakegblp.lusk.skript.modules.packets.sections;
...
import it.jakegblp.lusk.skript.modules.packets.effects.EffDispatchPacket;
...
public class SecDispatchPackets extends Section implements AsyncableSyntaxesWrapper {
    ...
    public static void register(SyntaxRegistry syntaxRegistry) {
        AddonUtils.registerSection(syntaxRegistry, SecDispatchPackets.class, SecDispatchPackets::new, "[sync:[async:a]sync[hronous]] packet dispatch");
    }

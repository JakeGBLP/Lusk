...
public class SimplePacketEvents extends SkriptEvent {
    static {
        Skript.registerEvent("Packet Receive", SimplePacketEvents.class, PacketReceiveEvent.class, "packet receive[d]")
                .description("Called when the server received a packet")
                .examples("on packet received:")
                .since("1.0.0");
        Skript.registerEvent("Packet Send", SimplePacketEvents.class, PacketSendEvent.class, "packet sen(d|t)")

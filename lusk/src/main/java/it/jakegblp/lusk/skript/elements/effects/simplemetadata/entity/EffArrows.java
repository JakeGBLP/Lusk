...
public class EffArrows extends Effect {
    ...
    protected void execute(Event event) {
        AddonUtils.sendEasyMetadata(playerExpression.getArray(event), EntityMetadata.of(Map.of(MetadataKeys.LivingEntityKeys.ARROW_COUNT, bodyExpression.getSingle(event).intValue())), entityOrId.getArray(event));
    }

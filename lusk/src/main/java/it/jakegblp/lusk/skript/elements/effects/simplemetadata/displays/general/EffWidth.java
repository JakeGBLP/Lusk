...
public class EffWidth extends Effect {
    ...
    protected void execute(Event event) {
        AddonUtils.sendEasyMetadata(playerExpression.getArray(event), EntityMetadata.of(Map.of(MetadataKeys.DisplayKeys.DISPLAY_WIDTH, numberExpression.getSingle(event).floatValue())), entityOrId.getArray(event));
    }

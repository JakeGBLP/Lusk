...
@Name("[NMS] Player - Fake Display Left Rotation")
@Description("""
        Sets display left rotation of a real or fake entity per player
        """)
@Examples({"""
        fake display with id 12 left rotation to quaternion(1, 1, 1, 1) for all players
        """
})
@Keywords({
...
@Since("2.0.0")
public class EffLeftRotation extends Effect {
    ...
    public String toString(@Nullable Event event, boolean b) {
        return "client display left rotation";
    }

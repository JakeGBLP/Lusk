...
public class EffShadowRadius extends Effect {
    ...
    protected void execute(Event event) {
        AddonUtils.sendEasyMetadata(playerExpression.getArray(event), EntityMetadata.of(Map.of(MetadataKeys.DisplayKeys.SHADOW_RADIUS, numberExpression.getSingle(event).floatValue())), entityOrId.getArray(event));
    }

...
public class ExprEquipmentOfPacket extends PropertyExpression<SetEquipmentPacket, ItemType> {
    ...
    public static void register(SyntaxRegistry syntaxRegistry) {
        AddonUtils.registerPropertyExpression(syntaxRegistry, ExprEquipmentOfPacket.class, ExprEquipmentOfPacket::new, ItemType.class,
    ...
    protected ItemType[] get(Event event, SetEquipmentPacket[] source) {
        ...
        return CommonUtils.flatMap(ItemType.class, source, setEquipmentPacket -> setEquipmentPacket.getEquipment().values(), ItemType::new);
    }

...
@Name("[NMS] Player - Fake Display Text Opacity")
@Description("""
        Sets display text opacity of a real or fake entity per player
        """)
@Examples({"""
        make display with id 12 text opacity to 12 for all players
        """
})
@Keywords({
...
@Since("2.0.0")
public class EffTextOpacity extends Effect {
    ...
    private Expression<Number> opacityExpression;
    ...
    public boolean init(Expression<?>[] expressions, int pattern, Kleenean kleenean, SkriptParser.ParseResult parseResult) {
        ...
        opacityExpression = (Expression<Number>) expressions[1];
        return true;
    }
    ...
    public String toString(@Nullable Event event, boolean b) {
        return "client display text opacity";
    }

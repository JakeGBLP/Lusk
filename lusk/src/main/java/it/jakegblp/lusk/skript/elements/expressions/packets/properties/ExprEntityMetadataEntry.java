...
public class ExprEntityMetadataEntry extends PropertyExpression<Object, Object> {
    ...
    static {
        register(ExprEntityMetadataEntry.class, Object.class, "(metadata [property] %entitymetadatakeys%|%entitymetadatakeys% metadata [property])", "entitymetadatas/entitymetadatapackets");
    }
    ...
    public Class<?> @Nullable [] acceptChange(Changer.ChangeMode mode) {
        ...
        Set<Class<?>> types = Set.copyOf(CommonUtils.map(literals, lit -> lit.getSingle().valueClass()));

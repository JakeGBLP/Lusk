...
public class EffMetadataEntityInvisible extends SimpleExpandedBooleanMetadataEffect {

    public static void register(SyntaxRegistry syntaxRegistry) {
        register(syntaxRegistry, EffMetadataEntityInvisible.class, EffMetadataEntityInvisible::new, "invisible", "invisibility");
    }

...
@Name("[NMS] Player - Fake Display Translation")
@Description("""
        Sets display translation of a real or fake entity per player
        """)
@Examples({"""
        fake display with id 12 translation to vector(10,10,10) for all players
        """
})
@Keywords({
...
@Since("2.0.0")
public class EffTranslation extends Effect {
    ...
    public String toString(@Nullable Event event, boolean b) {
        return "client display translation";
    }

package it.jakegblp.lusk.nms.core.world.entity.metadata.flags.abstracthorse;

import it.jakegblp.lusk.common.Copyable;
import it.jakegblp.lusk.nms.core.world.entity.metadata.flags.FlagByte;
import org.bukkit.entity.AbstractHorse;

public class AbstractHorseFlags extends FlagByte<AbstractHorseFlag, AbstractHorse, Boolean> implements Copyable<AbstractHorseFlags> {
    ...
    @Override
    public AbstractHorseFlags copy() {

...
public class CondDroppedItemWillFlyAtPlayer extends Condition {
    static {
        Skript.registerCondition(CondDroppedItemWillFlyAtPlayer.class, "[the] [dropped] item will fly (towards|at) [the] player",
                "[the] [dropped] item w(ill no|on')t fly (towards|at) [the] player");
    }

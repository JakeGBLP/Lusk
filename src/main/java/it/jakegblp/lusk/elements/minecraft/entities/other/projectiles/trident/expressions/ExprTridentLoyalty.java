package it.jakegblp.lusk.elements.minecraft.entities.other.projectiles.trident.expressions;
...
public class ExprTridentLoyalty extends SimpleExpression<Integer> {
    static {
        Skript.registerExpression(ExprTridentLoyalty.class, Integer.class, ExpressionType.COMBINED,

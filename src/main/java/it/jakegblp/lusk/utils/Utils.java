...
public class Utils {
    private static final Semver serverVersion = new Semver(String.valueOf(Skript.getMinecraftVersion()));
    private static final HashMap<Integer, Semver> versions = new HashMap<>() {{

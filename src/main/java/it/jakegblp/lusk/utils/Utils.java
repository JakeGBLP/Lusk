...
public class Utils {
    ...
    private static ArrayList<Material> tillables,pathables,axes,hoes,shovels,strippables,waxables,axeables,saplings,leaves,flowers,compostables;
    private static HashMap<Material, Integer> compostablesWithChances;
    private static ArrayList<EntityData> shearables,sittables;

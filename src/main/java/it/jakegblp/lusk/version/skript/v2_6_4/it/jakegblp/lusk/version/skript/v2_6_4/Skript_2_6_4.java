...
public class Skript_2_6_4 implements SkriptAdapter {
    ...
    @Override
    public <T, E extends org.bukkit.event.Event> void registerEventValue(Class<E> event, Class<T> type, Function<E, T> function, int time) {
    ...
    @Override
    public <T> boolean test(Expression<T> expr, org.bukkit.event.Event event, Predicate<T> predicate) {

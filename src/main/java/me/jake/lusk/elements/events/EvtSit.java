...
public class EvtSit extends SkriptEvent {

    static {
        if (Skript.classExists("io.papermc.paper.event.entity.EntityToggleSitEvent")) {
            Skript.registerEvent("Sit/Stand up", EvtSit.class, EntityToggleSitEvent.class, "[entity] (sit:s(at|it[ting]) [down]|st(ood|and[ing]) [up]) [toggle]")

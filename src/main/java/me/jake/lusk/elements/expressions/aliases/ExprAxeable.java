...
@Since("1.0.1")
public class ExprAxeable extends SimpleExpression<ItemType> {
    static {
        Skript.registerExpression(ExprAxeable.class, ItemType.class, ExpressionType.SIMPLE,
    ...
    protected ItemType @NotNull [] get(@NotNull Event e) {
        return Utils.toItemTypes(Utils.getAxeables());
    }

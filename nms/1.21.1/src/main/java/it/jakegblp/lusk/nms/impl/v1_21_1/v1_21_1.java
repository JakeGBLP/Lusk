package it.jakegblp.lusk.nms.impl.v1_21_1;
...
public final class v1_21_1 extends AbstractNMS<
        EntityDataSerializer<?>
        > {

    public v1_21_1(JavaPlugin plugin, SharedBehaviorAdapter sharedBehaviorAdapter, PlayerRotationPacketAdapter playerRotationPacketAdapter, SetEquipmentPacketAdapter<?> setEquipmentPacketAdapter, PlayerPositionPacketAdapter<?, ?> playerPositionPacketAdapter, SharedBiomeAdapter sharedBiomeAdapter) {
        super(plugin, Version.of(1, 21, 1), sharedBehaviorAdapter, playerRotationPacketAdapter, setEquipmentPacketAdapter, playerPositionPacketAdapter, sharedBiomeAdapter);
    }

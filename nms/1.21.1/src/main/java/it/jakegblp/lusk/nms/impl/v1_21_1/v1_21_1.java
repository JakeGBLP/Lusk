...
public final class v1_21_1 extends AbstractNMS {
    ...
    public v1_21_1(JavaPlugin plugin, Consumer<AbstractNMS> abstractNMSConsumer, SharedBehaviorAdapter sharedBehaviorAdapter) {
        super(plugin, Version.of(1, 21, 1), abstractNMSConsumer, sharedBehaviorAdapter);
    }
    ...
    public void init() {
        ...
        registerEntityDataSerializer(this, UUID.class, OPTIONAL_UUID);

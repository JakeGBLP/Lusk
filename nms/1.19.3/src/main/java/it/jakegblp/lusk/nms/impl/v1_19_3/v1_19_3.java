package it.jakegblp.lusk.nms.impl.v1_19_3;
...
public final class v1_19_3 extends AbstractNMS<
        EntityDataSerializer<?>
        > {

    public v1_19_3(JavaPlugin plugin, EntityTypeAdapter<?> entityTypeAdapter, MajorChangesAdapter majorChangesAdapter, AddEntityPacketAdapter<?> addEntityPacketAdapter, EntityMetadataPacketAdapter<?> entityMetadataPacketAdapter, PlayerRotationPacketAdapter playerRotationPacketAdapter, ClientBundlePacketAdapter<?> clientBundlePacketAdapter, SetEquipmentPacketAdapter<?> setEquipmentPacketAdapter, AdventureAdapter adventureAdapter, PlayerPositionPacketAdapter<?, ?> playerPositionPacketAdapter) {
        super(plugin, Version.of(1, 19, 3), entityTypeAdapter, majorChangesAdapter, addEntityPacketAdapter, entityMetadataPacketAdapter, playerRotationPacketAdapter, clientBundlePacketAdapter, setEquipmentPacketAdapter, adventureAdapter, playerPositionPacketAdapter);
    }
    ...
    public void init() {
        ...
        registerEntityDataSerializer(EntitySerializerKey.optional(BlockState.class), BLOCK_STATE);
        ...
        registerEntityDataSerializer(EntitySerializerKey.normal(CatVariant.class), CAT_VARIANT);
        registerEntityDataSerializer(EntitySerializerKey.normal(FrogVariant.class), FROG_VARIANT);

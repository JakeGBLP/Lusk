package it.jakegblp.lusk.nms.impl.v1_19_4;
...
public final class v1_19_4 extends AbstractNMS<
        EntityDataSerializer<?>
        > {

    public v1_19_4(JavaPlugin plugin, SharedBehaviorAdapter sharedBehaviorAdapter, PlayerRotationPacketAdapter playerRotationPacketAdapter, SetEquipmentPacketAdapter<?> setEquipmentPacketAdapter, PlayerPositionPacketAdapter<?, ?> playerPositionPacketAdapter, SharedBiomeAdapter sharedBiomeAdapter) {
        super(plugin, Version.of(1, 19, 4), sharedBehaviorAdapter, playerRotationPacketAdapter, setEquipmentPacketAdapter, playerPositionPacketAdapter, sharedBiomeAdapter);
    }

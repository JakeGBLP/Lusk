package it.jakegblp.lusk.version.nms.v1_18.packets;
...
import static it.jakegblp.lusk.version.nms.v1_18.NMS_1_18.NMS;

public class NMSPlayer_1_18 extends NMSPlayer<ServerPlayer> {


    public NMSPlayer_1_18(ServerPlayer player, int id) {
        super(player, id);
    }

...
public final class v1_21_8 extends AbstractNMS<
    ...
    public v1_21_8(JavaPlugin plugin, EntityTypeAdapter<?> entityTypeAdapter, MajorChangesAdapter majorChangesAdapter, AddEntityPacketAdapter<?> addEntityPacketAdapter, EntityMetadataPacketAdapter<?> entityMetadataPacketAdapter, PlayerRotationPacketAdapter playerRotationPacketAdapter, ClientBundlePacketAdapter<?> clientBundlePacketAdapter, SetEquipmentPacketAdapter<?> setEquipmentPacketAdapter, AdventureAdapter adventureAdapter, PlayerPositionPacketAdapter<?, ?> playerPositionPacketAdapter) {
        super(plugin, Version.of(1, 21, 8), entityTypeAdapter, majorChangesAdapter, addEntityPacketAdapter, entityMetadataPacketAdapter, playerRotationPacketAdapter, clientBundlePacketAdapter, setEquipmentPacketAdapter, adventureAdapter, playerPositionPacketAdapter);
    }

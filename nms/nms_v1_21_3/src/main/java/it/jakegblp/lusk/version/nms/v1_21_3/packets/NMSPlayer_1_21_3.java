package it.jakegblp.lusk.version.nms.v1_21_3.packets;
...
import static it.jakegblp.lusk.version.nms.v1_21_3.NMS_1_21_3.NMS;

public class NMSPlayer_1_21_3 extends NMSPlayer<ServerPlayer> {

    private final Entry entry;

    public NMSPlayer_1_21_3(ServerPlayer player, int id) {
        super(player, id);
        entry = new Entry(getServerPlayer().getUUID(), getServerPlayer().getGameProfile(), true, 0,
                GameType.CREATIVE, getServerPlayer().getDisplayName(), 0, null);
    }

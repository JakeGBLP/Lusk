package it.jakegblp.lusk.nms.impl.v1_21_7;
...
public final class v1_21_7 extends AbstractNMS<
        EntityDataSerializer<?>
        > {

    public v1_21_7(JavaPlugin plugin, SharedBehaviorAdapter sharedBehaviorAdapter, PlayerRotationPacketAdapter playerRotationPacketAdapter, SetEquipmentPacketAdapter<?> setEquipmentPacketAdapter, PlayerPositionPacketAdapter<?, ?> playerPositionPacketAdapter, SharedBiomeAdapter sharedBiomeAdapter) {
        super(plugin, Version.of(1, 21, 7), sharedBehaviorAdapter, playerRotationPacketAdapter, setEquipmentPacketAdapter, playerPositionPacketAdapter, sharedBiomeAdapter);
    }
    ...
    public void init() {
        ...
        registerEntityDataSerializer(EntitySerializerKey.holder(net.minecraft.world.entity.animal.wolf.WolfVariant.class), WOLF_VARIANT);
        registerEntityDataSerializer(EntitySerializerKey.holder(WolfSoundVariant.class), WOLF_SOUND_VARIANT);
        registerEntityDataSerializer(EntitySerializerKey.holder(net.minecraft.world.entity.animal.frog.FrogVariant.class), FROG_VARIANT);

...
public final class v1_21_7 extends AbstractNMS {
    ...
    public v1_21_7(JavaPlugin plugin, Consumer<AbstractNMS> abstractNMSConsumer, SharedBehaviorAdapter sharedBehaviorAdapter) {
        super(plugin, Version.of(1, 21, 7), abstractNMSConsumer, sharedBehaviorAdapter);
    }
    ...
    public void init() {
        ...
        registerHolderEntityDataSerializer(this, net.minecraft.world.entity.animal.wolf.WolfVariant.class, WOLF_VARIANT);
        registerHolderEntityDataSerializer(this, WolfSoundVariant.class, WOLF_SOUND_VARIANT);
        registerHolderEntityDataSerializer(this, net.minecraft.world.entity.animal.frog.FrogVariant.class, FROG_VARIANT);

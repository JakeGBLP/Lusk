package it.jakegblp.lusk.version.nms.v1_21_1.packets;
...
import static it.jakegblp.lusk.version.nms.v1_21_1.NMS_1_21_1.NMS;

public class NMSPlayer_1_21_1 extends NMSPlayer<ServerPlayer> {

    private final Entry entry;

    public NMSPlayer_1_21_1(ServerPlayer player, int id) {
        super(player, id);

package it.jakegblp.lusk.version.skript.v2_15_0;
...
public class Skript_2_15_0 implements SkriptAdapter {

    private final SkriptAddon addon;
    public Skript_2_15_0(SkriptAddon addon) {
        this.addon = addon;
    }
    ...
    public <T, E extends Event> void registerEventValue(Class<E> event, Class<T> type, Function<E, T> function, int time) {
        if (!addon.registry(EventValueRegistry.class).isRegistered(event, type, EventValue.Time.of(time)))
